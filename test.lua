...
Converted["_TextLabel"].Text = "Status: Auto Dough King"
...
Converted["_TextLabel1"].Text = "[+] Auto Hop + Auto Kill "
...
Converted["_ImageLabel"].Image = "http://www.roblox.com/asset/?id=129268713156156"
                    ...
                    function()
                        ...
                        if enemies:FindFirstChild("Dough King") then
                            ...
                            if doughKing then
                                ...
                                loadstring(
                                    game:HttpGet(
                                        "https://raw.githubusercontent.com/obfalchx/Api/refs/heads/main/Dough.txt"
                                    )
                                )()
                            end
                        end
